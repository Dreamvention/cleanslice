...
import type { UploadFileData, GetSignedUrlData, GetSignedUrlResponse, GetFilesData, GetFilesResponse, CreateFileData, CreateFileResponse, DeleteFileData, DeleteFileResponse, GetFileData, GetFileResponse, GetUsersData, GetUsersResponse, CreateUserData, CreateUserResponse, DeleteUserData, GetUserData, GetUserResponse, UpdateUserData, UpdateUserResponse, MeData, MeResponse, LoginData, LoginResponse, RegisterData, RegisterResponse, RegisterError, RefreshData, RefreshResponse, AuthControllerConfirmData, ResendConfirmData, GetApiKeysData, GetApiKeysResponse, CreateApiKeyData, CreateApiKeyResponse, DeleteApiKeyData, DeleteApiKeyResponse, GetApiKeyData, GetApiKeyResponse, UpdateApiKeyData, UpdateApiKeyResponse, GetTeamsData, GetTeamsResponse, CreateTeamData, CreateTeamResponse, DeleteTeamData, GetTeamData, GetTeamResponse, UpdateTeamData, UpdateTeamResponse, MailsControllerHandleMailBouncesData, MailsControllerHandleMailComplaintsData, MailsControllerHandleMailDeliveriesData, GetHealthData } from './types.gen';
...
export class AuthService {
    ...
    public static refresh<ThrowOnError extends boolean = false>(options: Options<RefreshData, ThrowOnError>) {
        return (options.client ?? _heyApiClient).post<RefreshResponse, unknown, ThrowOnError>({
            url: '/auth/refresh',
            ...options,
            headers: {
                'Content-Type': 'application/json',
    ...
    public static authControllerConfirm<ThrowOnError extends boolean = false>(options: Options<AuthControllerConfirmData, ThrowOnError>) {
...
export class MailsService {
    public static mailsControllerHandleMailBounces<ThrowOnError extends boolean = false>(options?: Options<MailsControllerHandleMailBouncesData, ThrowOnError>) {
        return (options?.client ?? _heyApiClient).post<unknown, unknown, ThrowOnError>({
            url: '/mails/bounces',
            ...options
        });
    ...
    public static mailsControllerHandleMailComplaints<ThrowOnError extends boolean = false>(options?: Options<MailsControllerHandleMailComplaintsData, ThrowOnError>) {
        return (options?.client ?? _heyApiClient).post<unknown, unknown, ThrowOnError>({
    ...
    public static mailsControllerHandleMailDeliveries<ThrowOnError extends boolean = false>(options?: Options<MailsControllerHandleMailDeliveriesData, ThrowOnError>) {
        return (options?.client ?? _heyApiClient).post<unknown, unknown, ThrowOnError>({
