...
export class UnstructuredLoader extends BaseDocumentLoader {
  ...
  async _partition(data?: Buffer) {
    ...
    return client.general
      ...
      .catch((e) => {
        ...
        throw new Error(
          `Failed to partition file ${this.filePath} with error ${e.statusCode} and message ${e.body || e.detail}`,
        );
      });
  ...
  async loadFile(data: Buffer): Promise<Document[]> {
    const elements = await this._partition(data);
