import { ref } from 'vue';
import { CreateTeamDto, VectorsService } from '#api/data';
...
export const useFormTeams = () => {
  ...
  const onSubmit = form.handleSubmit(async (values: any) => {
    ...
    await VectorsService.createVector({
      body: {
        name: 'test',
      }
    })
    ...
    // navigateTo({ name: pages.teamsItem, params: { teamId: teamsStore.team.codename } });
