...
import { IUserData, IUserGateway, ICreateUserData, RoleTypes } from '../../user/domain';
import { JwtService } from '@nestjs/jwt';
import * as bcrypt from 'bcrypt';
import { randomBytes } from 'crypto';
import { MailService } from '../../mail/domain/mail.service';
...
export class BasicAuthGateway implements IAuthGateway {
  constructor(
    ...
    private usersGateway: IUserGateway,
