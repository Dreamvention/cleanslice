...
export type MailControllerHandleMailBouncesData = {
  body?: never;
  path?: never;
  query?: never;
  url: '/mail/bounces';
...
export type MailControllerHandleMailBouncesResponses = {
  201: unknown;
};

export type MailControllerHandleMailComplaintsData = {
  body?: never;
  path?: never;
  query?: never;
  url: '/mail/complaints';
...
export type MailControllerHandleMailComplaintsResponses = {
  201: unknown;
};

export type MailControllerHandleMailDeliveriesData = {
  body?: never;
  path?: never;
  query?: never;
  url: '/mail/deliveries';
...
export type MailControllerHandleMailDeliveriesResponses = {
  201: unknown;
};
...
export type GenerateCompletionData = {
  body: CompletionDto;
  path?: never;
  query?: never;
...
export type GenerateCompletionResponses = {
  /**
